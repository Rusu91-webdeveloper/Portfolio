...
export const projects = [
  {
    ...
    img: "/project1.png",
    iconLists: [
      <IconBrandHtml5 key="html5" size={24} color="#E34F26" />,
      <IconBrandCss3 key="css3" size={24} color="#1572B6" />,
    ],
  ...
  },
  {
    ...
    img: "/project2.png",
    iconLists: [
      <IconBrandReact key="react" size={24} color="#61DAFB" />,
      <IconApi key="api" size={24} color="#FF5733" />,
    ],
  ...
  },
  {
    ...
    img: "/project3.png",
    iconLists: [
      <IconBrandNextjs key="nextjs" size={24} color="#fff" />,
      <IconDatabase key="mongodb" size={24} color="#4DB33D" />,
      <IconBrandNodejs key="nodejs" size={24} color="#339933" />,
    ],
  ...
  },
  {
    ...
    img: "/project4.png",
    iconLists: [<IconBrandNextjs key="nextjs" size={24} color="#fff" />],
  ...
  },
  {
    ...
    img: "/project5.png",
    iconLists: [
      <IconBrandNodejs key="nodeJs" size={24} color="#fff" />,
      <IconBrandReact key="react" size={24} color="#61DAFB" />,
    ],
 ...
 ---- Pass: Guest!234 ----
  ...
  This platform works seamlessly with the Nexus Guest Webpage to provide a connected experience, empowering our team to deliver an exceptional guest experience.`,
    ...
    href: "https://nexus-management-frontend-b7zu.onrender.com/",
  },
];
