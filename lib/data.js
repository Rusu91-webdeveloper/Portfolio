...
export const projects = [
  {
    ...
    img: "/project1.png",
    iconLists: [
      <IconBrandHtml5 key={html} size={24} color="#E34F26" />,
      <IconBrandCss3 key={css} size={24} color="#1572B6" />,
    ],
  ...
  },
  {
    ...
    img: "/project3.png",
    iconLists: [
      <IconBrandNextjs key={next} size={24} color="#fff" />,
      <IconDatabase key={db} size={24} color="#4DB33D" />,
      <IconBrandNodejs key={node} size={24} color="#339933" />,
    ],
